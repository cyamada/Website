            ...
            */
            _onMoveCube:function (evt) {
                ...
                if (this._gesture){
                    ...
                    this._moved = true;
                    this._cube.setStyle('transform','rotateX('+ 30  + 'deg) rotateY('+ 30 + 'deg)');
                }else{
                    this._moved = false;
                }
            },
            ...
            */
            _onEndCube:function (evt) {
                ...
                var threshold = 70,//ToDo: Double check this value in different devices
                    ...
                    console.log(parts);
                    this._expectingTransition = true;
                    if (frame.hands.length > 0) {console.log('working');}
                ...
                switch(true){
                    ...
                    case parts[2] != "up" && parts[2] != "down" && mHorizontal:
                        ...
                        /*
                        console.log('case1');
                        console.log(parts[4].charAt(0));
                        console.log(parts[4].charAt(1))
            ...
            _reorganizeCubies:function () {
                var m = this._movement;
                    var changes = CUBIE_MOVEMENTS[m.face + m.slice +'-' +m.rotate];
